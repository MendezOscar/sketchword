...
class NewEditSketches extends StatefulWidget {
  final String idUser;
  final String sketchId;
  final bool isEditing;
  final Sketches? sketchToEdit;

  const NewEditSketches(
      {super.key,
  ...
  @override
  State<NewEditSketches> createState() => _NewSketchesState();
}

class _NewSketchesState extends State<NewEditSketches> {
  ...
  Widget build(BuildContext context) {
    ...
    type = widget.sketchToEdit?.type ?? 'Expositivo';
    category = widget.sketchToEdit?.category ?? 'Edificacion';
        ...
        builder: (BuildContext context) {
          return SizedBox(
            child: Center(
              ...
              pointSketchToEdit: widget.isEditing ? pointSketch : null,
            )),
          );
        },
      ).then((value) => {
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: MyAppBar(
          title: widget.isEditing ? 'Editar bosquejo' : 'Nuevo bosquejo',
          icon: IconButton(
